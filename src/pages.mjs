    ...
    h(
      ...
      h(
        ...
        h(
          "h2",
          { id: "entry-log" },
          h("a", { href: "#entry-log", "data-anchor": true }, "entry log")
        ),
          ...
          h(
            ...
            h(
              ...
              h(
                "span",
                { class: "p0" },
                frontmatter.date.toFormat("dd LLL yyyy")
              ),
...
export function Feed({ entries }) {
  return h(
    ...
    h(
      "author",
      h("name", "Philipp"),
      h("uri", "https://pumuckl93.github.io/til/")
    ),
    h(
      "rights",
    ...
    entries.map(({ markdown, frontmatter, lastModified }) =>
      h(
        ...
        h("link", {
          rel: "alternate",
          type: "text/html",
          href: canonicalPath(`/${frontmatter.permalink}/`),
        }),
        ...
        h("content", {
          type: "html",
          innerHTML: `<![CDATA[${render(mdjsx(markdown, { components }))}]]>`,
        }),
        h(
          "rights",
...
export function Page({
  ...
  return h(
    ...
    h(
      ...
      h(
        "article",
        h("h1", h("a", { href: "../" }, "til"), h("span", frontmatter.title)),
        h(Content, { components })
      ),
      h(
        "footer",
        (prev || next) &&
          h(
            ...
            prev &&
              h(
                "a",
                { href: `../${prev.permalink}/`, class: "prev" },
                prev.title
              ),
            next &&
              h(
                "a",
                { href: `../${next.permalink}/`, class: "next" },
                next.title
              )
          ),
        h(
...
function Document({ children }) {
  return h(
    ...
    h(
      ...
      h("link", {
        rel: "shortcut icon",
        href: useRelPath("/assets/favicon.png"),
      }),
    ...
    h(
      ...
      h(
        ...
        h(
          "a",
          { href: "https://pumuckl93.github.io/til/" },
...
function GTag() {
  return [
    h("script", {
      async: true,
      src: "https://www.googletagmanager.com/gtag/js?id=UA-61714711-1",
    }),
    h("script", {
      innerHTML: `
...
function Attribution({ filename, frontmatter: { permalink, date } }) {
  return [
    ...
    h(
      "span",
      { property: "dct:created", content: date.toISO() },
      date.toLocaleString({
        year: "numeric",
        month: "short",
        day: "numeric",
    ...
    h(
      "a",
      {
        href: `https://raw.githubusercontent.com/pumuckl93/til/main/entries/${encodeURIComponent(
          filename
        )}`,
        target: "_blank",
      },
    ...
    h(
      "a",
      {
        href: `https://github.com/pumuckl93/til/edit/main/entries/${encodeURIComponent(
          filename
        )}#L8`,
        target: "_blank",
      },
